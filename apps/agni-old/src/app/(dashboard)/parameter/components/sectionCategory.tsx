...
export function SectionCategory({ categories, onUpdateCategory, onDeleteCategory, onAddCategory }: Props) {
    ...
    async function search(event: any) {
        let found_categories = searchInArr(event.target.value, categories.map(category => category.name));
        setSearchingCategories(categories.filter(category => found_categories.includes(category.name)));
