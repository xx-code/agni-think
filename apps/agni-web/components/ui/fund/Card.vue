...
const percEv = computed(() => roundNumber(computePercentage(fund.target, fund.balance))) 
    ...
    <UiFundCardContext :fund-id="fund.id" @refresh="v => emit('refresh', v)">
        <div class="p-5 rounded-xl bg-white border border-gray-200 h-full cursor-pointer hover:shadow-sm">
            ...
            <div class="m-auto flex  items-center">
                <div class="flex-1">
                    <div class="flex text-gray-400 text-sm gap-1 items-center p-2" v-if="fund.goalSummary">
