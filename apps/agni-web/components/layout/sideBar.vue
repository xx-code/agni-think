    ...
    [
        { 
            ...
            children: [
                ...
                {
                    label: 'Factures a venir',
                    icon: 'i-lucide-calendar-clock',
                    to: '/schedule-invoices'
                }
            ]
        },
        {
            label: 'Departement Comptable',
            icon: 'i-lucide-landmark',
            children: [
                {
                    label: 'Organizations' ,
                    icon: 'i-lucide-network',
                    to: '/accounting-department/network'
                },
                {
                    label: 'Rapports',
                    icon: 'i-lucide-clipboard-plus',
                    to: '/accounting-department/reports'
                },
                {
                    label: 'Audits',
    ...
    [
        {
            ...
            //     },
            //     {
            //         label: 'Principe & Regles',
            //         icon: 'i-lucide-school'
            //     },
            //     {
            //         label: 'Sync compte bancaire',
...
<template>
    <UDashboardSidebar 
        ...
        <template #default="{ collapsed }">
            <UNavigationMenu 
                :ui="{
                    linkLabel: 'block text-sm text-start text-wrap'
                }"
                highlight
                variant="pill"
                :collapsed="collapsed"
